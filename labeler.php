...
$post_url = "send_post.php?sample=" . $sample_idx;
    ...
    <form action="" method="post">
      <div>
        ...
        <select id="species_common_name" name="species_common_name" style="width:250px;height:100px" multiple>
          <option value="No bird species">No bird species</option>
      ...
      <textarea id="selected_species" placeholder="Select using menu above" name="selected_species" style="background:rgb(210,210,210);height:200px;width:300px" readonly></textarea>
